...
class Maze(object):
    ...
    def __init__(self, num_rows, num_cols, id=0, algorithm = "dfs_backtrack"):
        ...
        self.solution_cost1 = -1         #ADD Cost를 Return 하려고 추가.
        self.solution_time1 = 0.0        #ADD uniform cost search 알고리즘의 소모 시간 저장을 위해 추가.
        self.solution_path = None
        self.solution_cost2 = -1         #ADD Cost를 Return 하려고 추가.
        self.solution_time2 = 0.0        #ADD A* search 알고리즘의 소모 시간 저장을 위해 추가.
