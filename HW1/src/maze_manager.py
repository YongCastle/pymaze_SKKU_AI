...
from src.mysolver import AStarSearch
from src.mysolver import UniformCostSearch
...
class MazeManager(object):
    ...
    def solve_maze(self, maze_id, method, neighbor_method="fancy"):
        ...
        """
        maze = self.get_maze(maze_id)                                   #iD에 따른 Maze객체 반환.
        if maze is None:
        ...
        if method == "DepthFirstBacktracker":
            ...
            maze.solution_path = solver.solve()
        elif method == "UniformCostSearch":                            #ADD
            solver = UniformCostSearch()
            maze.solution_cost1, maze.solution_path, maze.solution_time1 = solver.uniform_cost_search(maze)
        elif method == "AStarSearch":                                  #ADD
            solver = AStarSearch()
            maze.solution_cost2, maze.solution_path, maze.solution_time2 = solver.a_star_search(maze)
